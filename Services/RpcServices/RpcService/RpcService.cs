...
using System.Linq;
using CloudChains.Spv.Lib.CoinConfig;
using CloudChains.Spv.Lib.Requests.CreateRawTransaction;
using CloudChains.Spv.Lib.Responses;
using CloudChains.Spv.Lib.RPC.Connector;
using CloudChains.Spv.Lib.RPC.Specifications;
using CloudChains.Spv.Lib.Services.Coins.Base;
using CloudChains.Spv.Lib.SpvParameters;

using Microsoft.Extensions.Options;
using Newtonsoft.Json.Linq;

namespace CloudChains.Spv.Lib.Services
{
